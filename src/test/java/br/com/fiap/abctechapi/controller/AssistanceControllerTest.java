...
public class AssistanceControllerTest {
    ...
    @MockBean
    private AssistanceApplicationImpl assistanceApp;
    ...
    public void test_get_assistance() {
        ...
        Mockito.when(assistanceApp.getAssists()).thenReturn(expectedAssists);

        // Call the method
        ResponseEntity<List<AssistResponseDto>> responseEntity = assistanceController.getAssists();
        ...
        // Verify
        Mockito.verify(assistanceApp).getAssists();
    }
}